...
|   CLPM_hyp       |  CLPM using **mother report** ratings for AD and SI, and **hyperacitivty** scores                                                 |
...
CLPM_hyp <- '
  # Estimate the lagged effects between the observed variables.
  hyem7 + isolation_mother_07 ~ hyem5 + isolation_mother_05
  hyem10 + isolation_mother_10 ~ hyem7 + isolation_mother_07
  hyem12 + isolation_mother_12 ~ hyem10 + isolation_mother_10

  # Estimate the covariance between the observed variables at the first wave. 
  hyem5 ~~ isolation_mother_05 # Covariance
  
  # Estimate the covariances between the residuals of the observed variables.
  hyem7 ~~ isolation_mother_07
  hyem10 ~~ isolation_mother_10
  hyem12 ~~ isolation_mother_12
  
  # Estimate the (residual) variance of the observed variables.
  hyem5 ~~ hyem5 # Variances
  isolation_mother_05 ~~ isolation_mother_05 
  hyem7 ~~ hyem7 # Residual variances
  isolation_mother_07 ~~ isolation_mother_07 
  hyem10 ~~ hyem10 
  isolation_mother_10 ~~ isolation_mother_10 
  hyem12 ~~ hyem12 
