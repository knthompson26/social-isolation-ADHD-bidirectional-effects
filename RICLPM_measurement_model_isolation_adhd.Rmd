...
```{r endorsemenr rate items lists}
...
```{r endorsement plot teacher mother}
...
For now the robust standard errors isn't computing for the pairwise deletion (I think this is an issue with the package). *So all models have se='robust' hashed out*
...
Two key points from [Hamaker et al., 2015](https://www.tandfonline.com/doi/pdf/10.1080/10705511.2020.1784738) (page 646 & 647)
...
```{r tables for hyperactivity ADHD S3}
# Table of model fit 
...
S4 Model fit:
(We have included here the change in CFI, TLI and RMSEA compared to the S3 model)
Comparative Fit Index (CFI)                    0.890 (>0.95)    Change in CFI:   0.058 (decrease) - worse fit 
Tucker-Lewis Index (TLI)                       0.888 (>0.95)    Change in TLI:   0.095 (decrease) - worse fit 
RMSEA                                          0.042 (≤ 0.06)   Change in RMSEA: 0.025 (increase) - worse fit
90 Percent confidence interval - lower         0.042 
90 Percent confidence interval - upper         0.043       
SRMR                                           0.081 (≤ 0.08)   Change in SRMR: 0.043 (increase)  - worse fit 
...
(We have included here the change in CFI, TLI and RMSEA compared to the S1 model)
Comparative Fit Index (CFI)                    0.995 (>0.95)    Change in CFI:   0.000 (same fit)
Tucker-Lewis Index (TLI)                       0.994 (>0.95)    Change in TLI:   0.000 (same fit)
RMSEA                                          0.013 (≤ 0.06)   Change in RMSEA: 0.000 (same fit)
90 Percent confidence interval - lower         0.011 
90 Percent confidence interval - upper         0.014       
SRMR                                           0.052 (≤ 0.08)   Change in SRMR:  0.000 (same fit)
...
S4 Model fit:
(We have included here the change in CFI, TLI and RMSEA compared to the S3 model)
Comparative Fit Index (CFI)                    0.956 (>0.95)    Change in CFI:   0.035 (decrease) - worse fit 
Tucker-Lewis Index (TLI)                       0.955 (>0.95)    Change in TLI:   0.035 (decrease) - worse fit 
RMSEA                                          0.034 (≤ 0.06)   Change in RMSEA: 0.018 (increase) - worse fit
90 Percent confidence interval - lower         0.033 
90 Percent confidence interval - upper         0.035       
SRMR                                           0.099 (≤ 0.08)   Change in SRMR: 0.039 (increase)  - worse fit 
