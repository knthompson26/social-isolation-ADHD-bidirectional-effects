...
**At the moment all models are using listwise deletion - if we decide we do not want to drop that many people, we can use pairwise deletion**
...
S4 Model fit:
(We have included here the change in CFI, TLI and RMSEA compared to the S1 model)
Comparative Fit Index (CFI)                    0.935 (>0.95)    Change in CFI:   0.056 (decrease) - worse fit
Tucker-Lewis Index (TLI)                       0.933 (>0.95)    Change in TLI:   0.057 (decrease) - worse fit
RMSEA                                          0.039 (≤ 0.06)   Change in RMSEA: 0.024 (increase) - worse fit
...
NEED TO ENTER S4 model for total ADHD here
