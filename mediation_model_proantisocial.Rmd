...
* ADHD predicts later isolation (f)
* asbsocial behaviours predict later lower ADHD (d)
* ADHD predicts later lower asbsocial behaviours (a)
* asbsocial behaviours predict later lower isolation (b)
* Significant indirect mediation path (a*b, p=0.003). ADHD -> lower asbsocial behaviours -> isolation
...
* All significant autoregressive lags
* Isolation *does not* predict later ADHD (e)
* Isolation *does not* predict later lower asbsocial behaviours (c)
* ADHD *does not* predict later isolation (f)
* asbsocial behaviours predict later lower ADHD (d)
* ADHD predicts later lower asbsocial behaviours (a)
* asbsocial behaviours predict later lower isolation (b)
* Significant indirect mediation path (a*b, p=0.007). ADHD -> lower asbsocial behaviours -> isolation
...
* asbsocial behaviours do predict later lower ADHD (d)
* ADHD *does not* predict later lower asbsocial behaviours (a)
* asbsocial behaviours *does* predict later lower isolation (b)
* **Nonsignificant** indirect mediation path (a*b, p=0.212). ADHD -> lower asbsocial behaviours -> isolation
...
* All significant autoregressive lags
* Isolation *does not* predicts later ADHD (e)
* Isolation predicts later lower asbsocial behaviours (c)
* ADHD predicts later isolation (f)
* asbsocial behaviours predict later lower ADHD (d)
* ADHD predicts later lower asbsocial behaviours (a)
* asbsocial behaviours predict later lower isolation (b)
* Significant indirect mediation path (a*b, p=0.0007). ADHD -> lower asbsocial behaviours -> isolation
...
* Isolation does *not* predict later lower asbsocial behaviours (c)
* ADHD does *not* predict later isolation (f)
* asbsocial behaviours **does** predict later lower ADHD (d)
* ADHD **does** predict later lower asbsocial behaviours (a)
* asbsocial behaviours *do not* predict later lower isolation (b)
* **Nonsignificant** indirect mediation path (a*b, p=0.153). ADHD -> lower asbsocial behaviours -> isolation
...
```{r LRT for ri.med.long.pro.t.fit and ri.med.long4a.pro.t.fit}
lavTestLRT(ri.med.long.pro.t.fit, ri.med.long4b.pro.t.fit, method = "satorra.bentler.2010")
```
...
```{r LRT for ri.med_hyp.long.pro.t.fit and ri.med_hyp.long4a.pro.t.fit}
lavTestLRT(ri.med_hyp.long.pro.t.fit, ri.med_hyp.long4b.pro.t.fit, method = "satorra.bentler.2010")
```
...
lavTestLRT(med_inat.long.pro.t.fit, med_inat.long2b.pro.t.fit, method = "satorra.bentler.2010")
```
...
```{r LRT for ri.med.long.asb.t.fit and ri.med.long4a.asb.t.fit}
#lavTestLRT(ri.med.long.asb.t.fit, ri.med.long4b.asb.t.fit, method = "satorra.bentler.2010")
```
...
```{r LRT for ri.med_hyp.long.asb.t.fit and ri.med_hyp.long4a.asb.t.fit}
lavTestLRT(ri.med_hyp.long.asb.t.fit, ri.med_hyp.long4b.asb.t.fit, method = "satorra.bentler.2010")
```
