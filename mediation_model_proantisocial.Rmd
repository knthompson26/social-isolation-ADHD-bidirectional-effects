...
med.simp.pro.m.fit <- sem(model = med.simp.pro.m, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med.simp.pro.m.fitsummary <- summary(med.simp.pro.m.fit, standardized = TRUE)
```

#### Hyperactivity symptoms 

```{r med_hyp.simp.pro.m}
med_hyp.simp.pro.m <- ' 
                  # direct effect
                   sisoem12 ~ c*hyem5
...
```{r  fit med_hyp.simp.pro.m}
med_hyp.simp.pro.m.fit <- sem(model = med_hyp.simp.pro.m, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_hyp.simp.pro.m.fitsummary <- summary(med_hyp.simp.pro.m.fit, standardized = TRUE)
```

#### Inattention symptoms 

```{r med_inat.simp.pro.m}
med_inat.simp.pro.m <- ' 
                  # direct effect
                   sisoem12 ~ c*inem5
...
```{r  fit med_inat.simp.pro.m}
med_inat.simp.pro.m.fit <- sem(model = med_inat.simp.pro.m, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_inat.simp.pro.m.fitsummary <- summary(med_inat.simp.pro.m.fit, standardized = TRUE)
```
...
med.simp.asb.m.fit <- sem(model = med.simp.asb.m, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med.simp.asb.m.fit.summary <- summary(med.simp.asb.m.fit, standardized = TRUE)
```

#### Hyperactivity symptoms

```{r med_hyp.simp.asb.m}
med_hyp.simp.asb.m <- ' 
                  # direct effect
                   sisoem12 ~ c*hyem5
...
```{r  fit med_hyp.simp.asb.m}
med_hyp.simp.asb.m.fit <- sem(model = med_hyp.simp.asb.m, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_hyp.simp.asb.m.fit.summary <- summary(med_hyp.simp.asb.m.fit, standardized = TRUE)
```

#### Inattention symptoms

```{r med_inat.simp.asb.m}
med_inat.simp.asb.m <- ' 
                  # direct effect
                   sisoem12 ~ c*inem5
...
```{r  fit med_inat.simp.asb.m}
med_inat.simp.asb.m.fit <- sem(model = med_inat.simp.asb.m, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_inat.simp.asb.m.fit.summary <- summary(med_inat.simp.asb.m.fit, standardized = TRUE)
```
...
med.simp.pro.t.fit <- sem(model = med.simp.pro.t, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med.simp.pro.t.fit.summary <- summary(med.simp.pro.t.fit, standardized = TRUE)
```

#### Hyperactivity symptoms 

```{r med_hyp.simp.pro.t}
med_hyp.simp.pro.t <- ' 
                  # direct effect
                   sisoet12 ~ c*hyet5
...
```{r  fit med_hyp.simp.pro.t}
med_hyp.simp.pro.t.fit <- sem(model = med_hyp.simp.pro.t, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_hyp.simp.pro.t.fit.summary <- summary(med_hyp.simp.pro.t.fit, standardized = TRUE)
```

#### Inattention symptoms 

```{r med_inat.simp.pro.t}
med_inat.simp.pro.t <- ' 
                  # direct effect
                   sisoet12 ~ c*inet5
...
```{r  fit med_inat.simp.pro.t}
med_inat.simp.pro.t.fit <- sem(model = med_inat.simp.pro.t, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_inat.simp.pro.t.fit.summary <- summary(med_inat.simp.pro.t.fit, standardized = TRUE)
```
...
med.simp.asb.t.fit <- sem(model = med.simp.asb.t, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med.simp.asb.t.fit.summary <- summary(med.simp.asb.t.fit, standardized = TRUE)
```

#### Hyperactivity symptoms

```{r med_hyp.simp.asb.t}
med_hyp.simp.asb.t <- ' 
                  # direct effect
                   sisoet12 ~ c*hyet5
...
```{r fit med_hyp.simp.asb.t}
med_hyp.simp.asb.t.fit <- sem(model = med_hyp.simp.asb.t, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_hyp.simp.asb.t.fit.summary <- summary(med_hyp.simp.asb.t.fit, standardized = TRUE)
```

#### Inattention symptoms

```{r med_inat.simp.asb.t}
med_inat.simp.asb.t <- ' 
                  # direct effect
                   sisoet12 ~ c*inet5
...
```{r fit med_inat.simp.asb.t}
med_inat.simp.asb.t.fit <- sem(model = med_inat.simp.asb.t, 
                        data = dat,
                        se = "bootstrap",
                        estimator = "ML")

med_inat.simp.asb.t.fit.summary <- summary(med_inat.simp.asb.t.fit, standardized = TRUE)
```
...
ri.med_hyp.long4b.asb.t <- ' 
                  ...
                  ###### Indirect effect isolation as the mediator ######
                  indirectisolation := b*e
         '
```
