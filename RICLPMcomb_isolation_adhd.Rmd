...
RICLPMcomb4 is *NOT* significantly worse fit (just) compared to RICLPMcomb2c (p = 0.06916) or RICLPM2d (p = . The parameter estimates also didn't change very much comapred to the RICLPMcomb2d model. 
