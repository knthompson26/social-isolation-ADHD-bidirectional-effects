...
RICLPMcomb.lag.c.fit.summary.reg.female <- table.model.coef(RICLPMcomb.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPMcomb.lag.c.fit.summary.reg.male <- table.model.coef(RICLPMcomb.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPMcomb_hyp.lag.c.fit.summary.reg.female <- table.model.coef(RICLPMcomb_hyp.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPMcomb_hyp.lag.c.fit.summary.reg.male <- table.model.coef(RICLPMcomb_hyp.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPM.lag.c.fit.summary.reg.female <- table.model.coef(RICLPM.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPM.lag.c.fit.summary.reg.male <- table.model.coef(RICLPM.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPM_hyp.lag.c.fit.summary.reg.female <- table.model.coef(RICLPM_hyp.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPM_hyp.lag.c.fit.summary.reg.male <- table.model.coef(RICLPM_hyp.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPM_inat.lag.c.fit.summary.reg.female <- table.model.coef(RICLPM_inat.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPM_inat.lag.c.fit.summary.reg.male <- table.model.coef(RICLPM_inat.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPMt.lag.c.fit.summary.reg.female <- table.model.coef(RICLPMt.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPMt.lag.c.fit.summary.reg.male <- table.model.coef(RICLPMt.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPMt_hyp.lag.c.fit.summary.reg.female <- table.model.coef(RICLPMt_hyp.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPMt_hyp.lag.c.fit.summary.reg.male <- table.model.coef(RICLPMt_hyp.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
...
# Table of regression and correlation (standardised covariances) coefficients
RICLPMt_inat.lag.c.fit.summary.reg.female <- table.model.coef(RICLPMt_inat.lag.c.fit.summary, sex = "Female", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
RICLPMt_inat.lag.c.fit.summary.reg.male <- table.model.coef(RICLPMt_inat.lag.c.fit.summary, sex = "Male", constraints = "Yes")[c(2,3,6,7,10,11),c(1,2,3,8,7)]
```
